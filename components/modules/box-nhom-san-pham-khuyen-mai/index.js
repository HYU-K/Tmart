...
export default function BoxNhomSanPhamKhuyenMai() {
    ...
    return (
        <div>
            <div className="bg-white relative overflow-hidden before:content-[attr(before)] before:w-full before:h-[2px] before:bg-red-600 before:absolute before:top-[12px] before:left-0 before:sm:hidden z-10 mb-5" id="">
                <div className={`w-full h-full absolute top-[12px] left-0 sm:hidden opacity-50 -z-10 ${styles.gradient}`}></div>
                <div
                    className="flex items-center justify-between relative w-fit mx-auto mb-4 sm:mb-0 sm:w-full z-10 px-8 xs:px-12 sm:px-4 py-2 sm:bg-red-100">
                    <div className="w-8 h-8 sm:hidden">
                        <img src="./images/icon/set.png" alt="" className="min-w-[30px] w-full" />
                    </div>
                    <h2 className="text-base uppercase text-center sm:text-left text-white sm:text-color1 font-medium">sản phẩm khuyến mãi</h2>
                    <div className="w-8 h-8 sm:hidden">
                    ...
                    <div className="max-w-2/3 lg:max-w-3/4 cursor-pointer hidden sm:block">
                        <div className="relative list-title-sale px-7">
                            ...
                            <div class="swiper-button-next absolute top-1/2 left-0 w-4 h-4 border border-red-500 rounded-full flex items-center justify-center transform -translate-y-1/2 before:ml-[1px] before:content-[attr(before)] before:w-[4px] before:h-[4px] before:border-t before:border-r before:border-red-600 before:rotate-[-135deg]"></div>
                            <div class="swiper-button-prev absolute top-1/2 right-0 w-4 h-4 border border-red-500 rounded-full flex items-center justify-center transform -translate-y-1/2 before:mr-[1px] before:content-[attr(before)] before:w-[4px] before:h-[4px] before:border-t before:border-r before:border-red-600 before:rotate-45"></div>
                        </div>
                    </div>
                </div>
                <div className="mb-3">
                    <div className="px-2 sm:p-0">
                        <div
                            className={`w-full grid gap-[5px] sm:gap-[1px] grid-cols-2 xs:grid-cols-3 xl:grid-cols-4 sm:bg-gray-300 mb-3 ${styles.list_home_products}`}>
                            {
                                prds.map((item, index) => (
                                    <ProductItem />
                                ))
