                ...
                <div
                    ...
                    <div className="max-w-2/3 lg:max-w-3/4 cursor-pointer hidden sm:block">
                        <div className="relative list-title-sale px-7">
                            ...
                            <div className="swiper-button-next absolute top-1/2 left-0 w-4 h-4 border border-red-500 rounded-full flex items-center justify-center transform -translate-y-1/2 before:ml-[1px] before:content-[attr(before)] before:w-[4px] before:h-[4px] before:border-t before:border-r before:border-red-600 before:rotate-[-135deg]"></div>
                            <div className="swiper-button-prev absolute top-1/2 right-0 w-4 h-4 border border-red-500 rounded-full flex items-center justify-center transform -translate-y-1/2 before:mr-[1px] before:content-[attr(before)] before:w-[4px] before:h-[4px] before:border-t before:border-r before:border-red-600 before:rotate-45"></div>
                        </div>
                    </div>
                </div>
                <div className="mb-3">
