        ...
        <>
            ...
            <div className="mb-6">
                <div className='flex items-center justify-between gap-4 mb-4 zoom-80 xs:zoom-100'>
                    ...
                    <label htmlFor="myfile" className='flex items-center gap-2 cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-camera-fill text-blue-500" viewBox="0 0 16 16">
                    ...
                    <div className="flex items-center mb-2">
                        ...
                        <div className="flex items-center ml-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="currentColor" className="text-yellow-300 stroke-yellow-400 ml-[2px]">
                                <path d="M7.17829 1.09863L9.12782 5.04816L13.4874 5.68538L10.3329 8.75794L11.0773 13.0986L7.17829 11.0482L3.27924 13.0986L4.02372 8.75794L0.869141 5.68538L5.22876 5.04816L7.17829 1.09863Z" fill="" stroke="" strokeWidth="1.03629" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="currentColor" className="text-yellow-300 stroke-yellow-400 ml-[2px]">
                                <path d="M7.17829 1.09863L9.12782 5.04816L13.4874 5.68538L10.3329 8.75794L11.0773 13.0986L7.17829 11.0482L3.27924 13.0986L4.02372 8.75794L0.869141 5.68538L5.22876 5.04816L7.17829 1.09863Z" fill="" stroke="" strokeWidth="1.03629" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
