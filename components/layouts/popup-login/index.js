...
export default function LoginPopup() {
    return (
        <div before=""
            ...
            <div
                className="w-11/12 max-w-lg bg-white rounded-xl px-4 py-5 sm:px-6 sm:py-7 lg:py-8 lg:px-12 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div
                ...
                <button
                    className="w-full p-4 bg-color1 border border-color1 mb-5 text-white leading-[0] rounded flex items-center justify-center relative before:duration-500 z-[1] before:content-[attr(before)] before:bg-white before:absolute before:top-0 before:left-0 before:w-full before:h-full before:z-[1] before:origin-center-left before:scale-x-0 hover:before:scale-100 hover:before:duration-500 hover:text-color1">
                    <span className="text-base font-medium leading-[100%] z-[2]">
                        Tiếp tục
                    </span>
                </button>
                <p className="text-base mb-5 text-texth">
                    Bằng cách đăng ký tài khoản, bạn đã đồng ý với{" "}
                    <a href="" title="" className="text-blue-500">
                        Điều khoản và Chính sách bảo mật{" "}
                    </a>
                    của T-Mart
                </p>
                <p className="text-base mb-5 text-texth text-center">
                    Hoặc sử dụng tài khoản
                </p>
                <div className="grid gap-5 grid-cols-2">
                    <button
                        className="flex items-center justify-center rounded overflow-hidden border border-green-500 p-3 hover:border-red-500">
                        <div className="mr-2">
