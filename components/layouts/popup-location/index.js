                ...
                <div className="">
                    ...
                    <div className="p-4">
                        <div class="w-full mb-5">
                            <div class="w-full border border-gray-300 overflow-hidden px-2 bg-white h-9 flex">
                                <input type="text" placeholder="Tìm nhanh tỉnh/thành, quận/huyện" class="w-full text-gray-300 focus:text-black text-[13px] outline-none" />
