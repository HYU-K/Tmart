        ...
        <div className="menu-top relative">
          <div
            ...
            <div className="hidden lg:block">
              <h3 className="text-sm text-texth uppercase font-bold">
                Danh mục sản phẩm
              </h3>
            </div>
          </div>
          <div className={`lg:h-fit scrollbar-none overflow-y-scroll fixed top-0 right-full max-w-xs h-full z-50
            bg-slate-50 p-4 w-full lg:absolute lg:top-full lg:left-0 lg:max-w-none border border-white
            lg:border-gray-300 ${styles.menu_main}`}>
            <div className="">
              ...
              <ul className="z-[999] overflow-hidden">
                ...
                <li id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                  ...
                  <div id="dropdownDivider" className="pl-3 pt-3 relative w-full hidden">
                    ...
                    <div className={`mb-3 min-w-full border-none relative w-full ${styles.active}`}>
                      ...
                      <div className={`pl-3 pt-3 w-full relative border-none hidden ${styles.sub_menu}`}>
                        <div className="mb-3">
                          <a className="text-xs text-texth font-medium hover:text-color1" href="" title="">
                            menu...
                          </a>
                        </div>
                        <div className="mb-3">
                      ...
                      <div
                        className="absolute right-0 top-[2px] rotate-0 translate-y-1/2 hover:text-color1 hover:rotate-90 transition-all">
                  ...
                  <div
                    className="absolute right-0 top-[2px] rotate-0 translate-y-1/2 group-hover:text-color1 group-hover:rotate-90 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor"
                      className="bi bi-chevron-right" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
              ...
              <ul>
                <li className="mb-4">
                  <a href="" title="" className="flex items-start">
                    <div className="mr-2 translate-y-[50%]">
                      <img src="../images/icon/li.png" alt="" />
                    </div>
      ...
      <div className="flex items-center justify-between px-1 py-2 w-full order-1 lg:order-2">
        ...
        <div className="flex items-center w-full">
          <div
            ...
            <select name="" id="" className="bg-transparent	text-white focus:text-black text-[13px] w-full lg:w-fit">
