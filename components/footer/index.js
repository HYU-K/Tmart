export default function Footer(props) {
    ...
    return (
        <>
            ...
            <div class="fixed bottom-5 right-5 xl:right-8 md:bottom-20 z-[900]">
                <a onclick="openForm()" title=""
                    class="zoom-70 xs:zoom-80 md:zoom-100 w-16 h-16 flex items-center flex-wrap justify-center mb-3 transition-all overflow-hidden bg-white rounded-full drop-shadow-2xl cursor-pointer">
                    <div class="">
                        <img src="./images/icon/mail.png" class="m-auto" />
                        <p class="text-[13px] uppercase text-green-500 font-medium">GÓP Ý</p>
                    </div>
                </a>
            ...
            <div class="fixed right-0 bottom-0 max-w-85 w-full bg-color1 rounded shadow-2xl p-1 overflow-hidden z-[1000] hidden"
                id="myForm">
                <nav class="w-full pt-2 pb-3 bg-color1 rounded-tr rounded-tl flex justify-between items-center">
                    <div class="flex justify-center items-center">
                        <img src="./images/icon/Logo-filnal.png" class="ml-1" width="36" height="32" />
                        <span class="text-xs font-medium text-white ml-2">T-Mart.com sẵn sàng hỗ trợ quý khách</span>
                    </div>
                    <button type="button" class="pr-2 text-white" onclick="closeForm()">
                    ...
                    <div class="w-full h-full p-3">
                        <div class="mb-5">
                            <textarea name="" id="" rows="3" placeholder="Nội dung (mô tả chi tiết)*"
                                class="rounded px-3 py-2 focus:outline-none border border-gray-300 h-auto placeholder-gray-400 text-black text-[13px] w-full"></textarea>
                        </div>
                        <div class="flex items-center ">
                            <label class="flex items-start cursor-pointer mb-5 mr-6">
                                <input type="radio" class="mt-[4px] mr-2" name="sex" />
                                <div class="text-[13px]"><span class="text-texth">Anh </span></div>
                            </label>
                            <label class="flex items-start cursor-pointer mb-5">
                                <input type="radio" class="mt-[4px] mr-2" name="sex" />
                                <div class="text-[13px]"><span class="text-texth">Nữ </span></div>
                            </label>
                        </div>

                        <div class="mb-5">
                            <input type="text"
                                class="rounded p-3 mb-2 focus:outline-none border border-gray-300 h-auto placeholder-gray-400 text-black text-[13px] w-full"
                        ...
                        <button class="w-full h-12 rounded-3xl overflow-hidden bg-color1 mb-4 flex items-center justify-center">
                            <span class="text-sm text-white font-medium">Bắt đầu chat</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="fixed right-0 bottom-0 max-w-85 w-full bg-color1 rounded shadow-2xl p-1 overflow-hidden z-[1000] hidden"
                ...
                <nav class="w-full pt-2 pb-3 bg-color1 rounded-tr rounded-tl flex justify-between items-center">
                    ...
                    <button type="button" class="pr-2 text-white" onclick="closeFormChat()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg"
                            viewBox="0 0 16 16">
                            <path
                                d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                ...
                <div class="w-full bg-white rounded overflow-hidden">
                    <div class="w-full h-full p-3">
                        <div class="mb-6">
                            <h3 class="text-[13px] mb-2.5 text-texth">Quý khách muốn xưng hô là:</h3>
                            <input type="text"
                                class="rounded px-3 py-2 focus:outline-none border border-gray-300 h-auto placeholder-gray-400 text-black text-[13px] w-full"
                                placeholder="Chọn cách xưng hô với quý khách" id="typemsg" />
                        </div>
                        <div class="mb-6">
                            <h3 class="text-[13px] mb-2.5 text-texth">Tên của Quý khách là:</h3>
                            <input type="text"
                                class="rounded px-3 py-2 focus:outline-none border border-gray-300 h-auto placeholder-gray-400 text-black text-[13px] w-full"
                                placeholder="Nhập tên của quý khách" id="typemsg" />
                        </div>
                        <div class="mb-6">
                            <h3 class="text-[13px] mb-2.5 text-texth">Số điện thoại của Quý khách là:</h3>
                            <input type="text"
                                class="rounded px-3 py-2 focus:outline-none border border-gray-300 h-auto placeholder-gray-400 text-black text-[13px] w-full"
                                placeholder="Nhập số điện thoại của quý khách" id="typemsg" />
                        </div>
                        <label class="flex items-start cursor-pointer mb-5">
                            <input type="radio" class="mt-[4px] mr-2" />
                            <div class="text-[13px]"><span class="text-texth">Bằng việc bắt đầu chat, Quý khách đã đồng ý với các
                            </span><a href="" title="" class="text-blue-500">điều
